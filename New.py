...
class IMG_Stegno:
    ...
    def main(self, root):
        root.title('Image Steganography by DataFlair')
    ...
    def encode_frame2(self, e_F2):
        ...
        cancel_button = Button(e_pg, text='Cancel', command=lambda: self.back(e_pg), font=('Helvetica', 14), bg='#e8c1c7')
        cancel_button.grid()
    ...
    def decode_frame2(self, d_F2):
        ...
        myfiles = tkinter.filedialog.askopenfilename(filetypes=[('Image files', '*.png;*.jpg;*.jpeg')])
        ...
        label2 = Label(d_F3, text='Hidden data is :', font=('Helvetica', 14, 'bold'))
        label2.grid(pady=10)
        ...
        button_back = Button(d_F3, text='Cancel', command=lambda: self.back(d_F3), font=('Helvetica', 14), bg='#e8c1c7')
        button_back.grid(pady=15)
    ...
    def enc_fun(self, text_a, myImg):
        ...
        newImg.save(tkinter.filedialog.asksaveasfilename(initialfile=temp + "_encoded", filetypes=[('png', '*.png')], defaultextension=".png"))
